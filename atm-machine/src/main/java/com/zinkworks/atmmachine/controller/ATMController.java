...
public class ATMController {
	...
	@PostMapping("/withdraw_2")
	public ResponseEntity<TransactionDTO> withdrawAmount_2(@RequestBody final WithdrawalRequest withdrawalRequest) {
		return new ResponseEntity<>(atmService.withdrawAmount_2(withdrawalRequest), HttpStatus.OK);
	}
